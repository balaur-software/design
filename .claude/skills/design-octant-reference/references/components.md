...
Counted from `packages/ui/src/{atoms,molecules,organisms}/` — recounted 2026-07-08, still at
HEAD `74aad33` with a clean tracked tree, counts unchanged:
...
(re-verified 2026-07-08) it IS exported from the barrel (`src/index.ts` re-exports it) and
